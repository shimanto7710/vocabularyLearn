...
public class LearnActivity extends AppCompatActivity {
    ...
    String TAG = LearnActivity.this.getClass().getSimpleName() + "learn";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rootLayout = (CardView) findViewById(R.id.learn_root_layout);
        noDataLayout = (LinearLayout) findViewById(R.id.no_data__learn_layout);
...
//            noDataPopup(getWindow().getDecorView());
    ...
    public void getNewWord(Word word, final int max) {
        ...
        switch (selectOption) {
            ...
            case 3:
                ...
                break;
            case 4:
                textop5.setText(word.getBangWord());
                break;
        }
    ...
    public void onButtonShowPopupWindowClick(View view, final Word word, final int max, final String result) {
...
//                        values.put("session", session);
                ...
                while (true) {
                    if (counter < wordList.size()) {
                        if (wordList.get(counter).getMood() != 2) {
                            f = true;
                            ff=false;
                            break;
                        } else {
...
//    public void noDataPopup(View view) {
//
//        // inflate the layout of the popup window
//        LayoutInflater inflater = (LayoutInflater)
//                getSystemService(LAYOUT_INFLATER_SERVICE);
